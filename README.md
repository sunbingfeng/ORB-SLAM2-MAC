...
## Cautions when running on MAC pro ( 2017.04.13 by sunbingfeng)
1. Pangolin : Erase "-gcc" and put "stdint.h" instead of "stdint-gcc.h"

2. ORB-SLAM2 src file:

the default creates viewer thread at slam system constructing, which may cause Pangolin crashing.
Now, we create it in the main thread.
